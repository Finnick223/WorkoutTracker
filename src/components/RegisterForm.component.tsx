...
export default function Form() {
    ...
    const onSubmit: SubmitHandler<FormDataType> = (data: any) => console.log(data)
                    ...
                    >
                        ...
                        <Box component="form" onSubmit={formMethods.handleSubmit(onSubmit)} sx={{mt: 2}}>
                            <Grid container spacing={1.5}>
                                ...
                                <Grid item xs={12}>
                                    <FormControl error={formMethods.formState.errors.gender ? true : false}>
                                        <FormLabel id="radio-buttons-group">Gender</FormLabel>
                                        <RadioGroup
                                            aria-labelledby="radio-buttons-group"
                                        >
                                            <FormControlLabel value="female" control={<Radio />} label="Female" {...formMethods.register("gender")}/>
                                            <FormControlLabel value="male" control={<Radio />} label="Male" {...formMethods.register("gender")}/>
                                        </RadioGroup>
                                        <FormHelperText>{formMethods.formState.errors.gender?.message}</FormHelperText>
                                    </FormControl>
                                </Grid>
                                <Grid item xs={12}>
                                    <FormControlLabel
